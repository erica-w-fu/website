...
// import img1 from 'public/project-media/Communication Design Fundamentals/gestalt-1.png'
// import img2 from 'public/project-media/Communication Design Fundamentals/gestalt-2.png'
        ...
        <>
            ...
            <div className="project-media-container">
                <div className="project-media">
                    <img src="project-media/Communication Design Fundamentals/gestalt-1.png" className="project-img"></img>
                </div>
            </div>
            <div className="project-media-container">
                <div className="project-media">
                    <img src="project-media/Communication Design Fundamentals/gestalt-2.png" className="project-img"></img>
                </div>
            </div>
        </>
    )
